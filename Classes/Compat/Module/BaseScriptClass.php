...
namespace Ppi\TemplaVoilaPlus\Compat\Module;
...
/**
 * Compatibility code: class taken from 9.5 source
 * Probably many parts are not used here @TODO: should be cleaned
 * 
 * 
...
{
	// original BaseScriptClass fields (probably some not needed)
	/**
    ...
    // Additional properties used in new tv modules, I decided to put them here too
